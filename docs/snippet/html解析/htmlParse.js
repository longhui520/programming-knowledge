...
const { proxyPlugin } = require("vite/dist/node/server/serverPluginProxy");
...
(function(){
	...
	this.HTMLtoNode = function(html){
		const createNode = function(tag,props,children){
			return {
				tag,
				props,
				children
	...
	console.log(JSON.stringify(this.HTMLtoNode('<div>222<span>22222</span<</div>'),null,2))
})();
